...
fun MessageReceiver.handleVisibleMessage(message: VisibleMessage,
    ...
    if (message.quote != null && proto.dataMessage.hasQuote()) {
        ...
        if (messageInfo != null) {
            ...
            quoteModel = QuoteModel(quote.id, author, false, attachments)
        } else {
            quoteModel = QuoteModel(quote.id, author, true, PointerAttachment.forPointers(proto.dataMessage.quote.attachmentsList))
        }
    }
