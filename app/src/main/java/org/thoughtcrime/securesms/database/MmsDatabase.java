...
public class MmsDatabase extends MessagingDatabase {
  ...
  public static String CREATE_MESSAGE_REQUEST_RESPONSE_COMMAND = "ALTER TABLE "+ TABLE_NAME + " " +
  ...
  public static String CREATE_REACTIONS_LAST_SEEN_COMMAND = "ALTER TABLE "+ TABLE_NAME + " " +
