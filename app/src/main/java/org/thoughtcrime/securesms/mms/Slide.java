...
import static org.thoughtcrime.securesms.conversation.v2.Util.usingLeftToRightLanguage;
...
public abstract class Slide {
  ...
  public Optional<String> getBody() {
    ...
    if (MediaUtil.isAudio(attachment)) {
      ...
      if (attachment.isVoiceNote() || attachment.getFileName() == null || attachment.getFileName().isEmpty()) {
        String baseString = context.getString(R.string.attachment_type_voice_message);
        boolean languageIsLTR = usingLeftToRightLanguage(context);
        String attachmentString = languageIsLTR ? "🎙 " + baseString : baseString + " 🎙";
  ...
  private String emojiForMimeType() {
    if (MediaUtil.isGif(attachment)) {
      ...
      return ""; // We don't provide emojis for other attachment types such as VCARD
    }
  }
