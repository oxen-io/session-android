...
public class SQLCipherOpenHelper extends SQLiteOpenHelper {
  ...
  private static final int lokiV17_AUDIO_ATTACHMENT_EXTRAS  = 38;

  private static final int    DATABASE_VERSION = lokiV17_AUDIO_ATTACHMENT_EXTRAS;
  ...
  public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
    ...
    try {
      ...
      if (oldVersion < lokiV17_AUDIO_ATTACHMENT_EXTRAS) {
